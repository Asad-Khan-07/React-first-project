...
const Body = () => {
  ...
  return (
    <>
     <div className={`${mode? "bg-[#040724]": "bg-white"} relative  w-full flex flex-col justify-center items-center mb:p-0 sm:p-2 sm:px-30  transition duration-500 ease`}>
        <h1 className={`${mode? "text-amber-100": "text-gray-900"} font-bold text-[50px] mb:text-center  text-start leading-tight mt-20 transition delay-150 duration-500 ease`}>Main Feature</h1>
...
<h1 className={` ${mode? "text-amber-100": "text-gray-900"} font-bold text-[50px] leading-tight text-center transition delay-150 duration-500 ease`}>We are ready to help</h1>
        <h3 className={` mt-5 ${mode? "text-amber-100": "text-gray-600"} mb:text-[20px] sm:text-[25px] text-center transition delay-150 duration-500 ease`}>There are many variations of passages of Lorem Ipsum available but the majority have suffered alteration in some form.</h3>
...
<iframe width="600" height="420" className='rounded-4xl mt-20 mb:w-2xs mb:h-70 sm:w-3xl sm:h-100' src="https://www.youtube.com/embed/L61p2uyiMSo?si=Dg3J5JeBjm6Ds0Q-" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    ...
    <div className={`${mode? "bg-gray-700": "bg-gray-200"} flex justify-evenly  mb:flex-col sm:flex-row mb:p-5  items-center mt-50 sm:p-20 gap-20 transition delay-150 duration-500 ease`}>
      ...
      <a href="https://tailgrids.com/" target='blank'>
        <img src="https://themewagon.github.io/startup-nextjs/images/brands/tailgrids.svg" alt="" width={250} />
      </a>
      <a href="https://lineicons.com/" target='blank'>
        <img src="https://themewagon.github.io/startup-nextjs/images/brands/lineicons.svg" alt="" width={250} />
      </a>
      <a href="https://ayroui.com/" target='blank'>
        <img src="https://themewagon.github.io/startup-nextjs/images/brands/ayroui.svg" alt="" width={250} />
      </a>
      <a href="https://plainadmin.com/" target='blank'>
        <img src="https://themewagon.github.io/startup-nextjs/images/brands/plainadmin.svg" alt="" width={250} />
      </a>
    </div>
...
<h1 className={`${mode? "text-amber-100": "text-gray-900"} font-bold text-[50px] leading-tight mb:text-center sm:text-start  transition delay-150 duration-500 ease`}>Crafted for Startup, SaaS and Business Sites.</h1>
        ...
        <ul className='grid sm:grid-cols-2 mb:grid-cols-1 mb:mt-15'>
          ...
          <li className='flex items-center'>
            <span className="mr-4 flex h-[30px] w-[30px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-blue-600"><svg width="16" height="13" viewBox="0 0 16 13" className="fill-current"><path d="M5.8535 12.6631C5.65824 12.8584 5.34166 12.8584 5.1464 12.6631L0.678505 8.1952C0.483242 7.99994 0.483242 7.68336 0.678505 7.4881L2.32921 5.83739C2.52467 5.64193 2.84166 5.64216 3.03684 5.83791L5.14622 7.95354C5.34147 8.14936 5.65859 8.14952 5.85403 7.95388L13.3797 0.420561C13.575 0.22513 13.8917 0.225051 14.087 0.420383L15.7381 2.07143C15.9333 2.26669 15.9333 2.58327 15.7381 2.77854L5.8535 12.6631Z"></path></svg></span>
            <span className={`text-[25px] ${mode? "text-amber-100": "text-gray-600"} transition delay-150 duration-500 ease`}>Use for lifetime</span>
          </li>
          <li className='flex items-center'>
            <span className="mr-4 flex h-[30px] w-[30px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-blue-600"><svg width="16" height="13" viewBox="0 0 16 13" className="fill-current"><path d="M5.8535 12.6631C5.65824 12.8584 5.34166 12.8584 5.1464 12.6631L0.678505 8.1952C0.483242 7.99994 0.483242 7.68336 0.678505 7.4881L2.32921 5.83739C2.52467 5.64193 2.84166 5.64216 3.03684 5.83791L5.14622 7.95354C5.34147 8.14936 5.65859 8.14952 5.85403 7.95388L13.3797 0.420561C13.575 0.22513 13.8917 0.225051 14.087 0.420383L15.7381 2.07143C15.9333 2.26669 15.9333 2.58327 15.7381 2.77854L5.8535 12.6631Z"></path></svg></span>
            <span className={`text-[25px] ${mode? "text-amber-100": "text-gray-600"} transition delay-150 duration-500 ease`}>Next.js</span>
          </li>
          <li className='flex items-center'>
            <span className="mr-4 flex h-[30px] w-[30px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-blue-600"><svg width="16" height="13" viewBox="0 0 16 13" className="fill-current"><path d="M5.8535 12.6631C5.65824 12.8584 5.34166 12.8584 5.1464 12.6631L0.678505 8.1952C0.483242 7.99994 0.483242 7.68336 0.678505 7.4881L2.32921 5.83739C2.52467 5.64193 2.84166 5.64216 3.03684 5.83791L5.14622 7.95354C5.34147 8.14936 5.65859 8.14952 5.85403 7.95388L13.3797 0.420561C13.575 0.22513 13.8917 0.225051 14.087 0.420383L15.7381 2.07143C15.9333 2.26669 15.9333 2.58327 15.7381 2.77854L5.8535 12.6631Z"></path></svg></span>
            <span className={`text-[25px] ${mode? "text-amber-100": "text-gray-600"} transition delay-150 duration-500 ease`}>Rich documentation</span>
          </li>
          <li className='flex items-center'>
            <span className="mr-4 flex h-[30px] w-[30px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-blue-600"><svg width="16" height="13" viewBox="0 0 16 13" className="fill-current"><path d="M5.8535 12.6631C5.65824 12.8584 5.34166 12.8584 5.1464 12.6631L0.678505 8.1952C0.483242 7.99994 0.483242 7.68336 0.678505 7.4881L2.32921 5.83739C2.52467 5.64193 2.84166 5.64216 3.03684 5.83791L5.14622 7.95354C5.34147 8.14936 5.65859 8.14952 5.85403 7.95388L13.3797 0.420561C13.575 0.22513 13.8917 0.225051 14.087 0.420383L15.7381 2.07143C15.9333 2.26669 15.9333 2.58327 15.7381 2.77854L5.8535 12.6631Z"></path></svg></span>
            <span className={`text-[25px] ${mode? "text-amber-100": "text-gray-600"} transition delay-150 duration-500 ease`}>Tailwind CSS</span>
          </li>
          <li className='flex items-center '>
            <span className="mr-4 flex h-[30px] w-[30px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-blue-600"><svg width="16" height="13" viewBox="0 0 16 13" className="fill-current"><path d="M5.8535 12.6631C5.65824 12.8584 5.34166 12.8584 5.1464 12.6631L0.678505 8.1952C0.483242 7.99994 0.483242 7.68336 0.678505 7.4881L2.32921 5.83739C2.52467 5.64193 2.84166 5.64216 3.03684 5.83791L5.14622 7.95354C5.34147 8.14936 5.65859 8.14952 5.85403 7.95388L13.3797 0.420561C13.575 0.22513 13.8917 0.225051 14.087 0.420383L15.7381 2.07143C15.9333 2.26669 15.9333 2.58327 15.7381 2.77854L5.8535 12.6631Z"></path></svg></span>
            <span className={`text-[25px] ${mode? "text-amber-100": "text-gray-600"} transition delay-150 duration-500 ease`}>Developer friendly</span>
          </li>
        </ul>
      </div>
      <div className='h-12/12'>
...
<span className='border-[1px] border-gray-300 w-full'></span>
      ...
      <div className=' h-12/12'>
        <ul className='grid grid-cols-1 gap-5'>
            <li>
              ...
              <h3 className={` mt-5 text-[25px] ${mode? "text-amber-100": "text-gray-600"} transition delay-150 duration-500 ease`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</h3>
            </li>
            <li>
              <h1 className={` text-2xl font-bold ${mode? "text-amber-100": "text-gray-900"} transition delay-150 duration-500 ease `}>Premier support</h1>
              <h3 className={` mt-5 text-[25px] ${mode? "text-amber-100": "text-gray-600"} transition delay-150 duration-500 ease`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</h3>
            </li>
            <li>
              <h1 className={` text-2xl font-bold ${mode? "text-amber-100": "text-gray-900"} transition delay-150 duration-500 ease `}>Next.js</h1>
              <h3 className={` mt-5 text-[25px] ${mode? "text-amber-100": "text-gray-600"} transition delay-150 duration-500 ease`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</h3>
            </li>
        </ul>
      </div>
    ...
    <div className={` ${mode? "bg-[#040724]": "bg-gray-100"} py-24 sm:py-32 mb: transition duration-500 ease`}>
      ...
      <div className="mx-auto grid max-w-7xl gap-20 px-6 lg:px-8 xl:grid-cols-1 place-items-center ">
        ...
        <div className="max-w-xl text-center">
          ...
          <p className={`mt-6 text-lg/8 text-center ${mode? "text-amber-100": "text-gray-600"} transition delay-150 duration-500 ease`}>
    ...
    viewport={{ once: true }}
            className='flex flex-col gap-5 shadow-md shadow-gray-500 p-5'>
              ...
              <span className={`text-lg/8  ${mode? "text-amber-100": "text-gray-600"} transition delay-150 duration-500 ease`}>
    ...
    <div className={` ${mode? "bg-[#040724]": "bg-white"} py-24 sm:py-32 transition duration-500 ease`}>
      <div className="absolute z-[100]"><svg width="239" height="601" viewBox="0 0 239 601" fill="none" xmlns="http://www.w3.org/2000/svg"><rect opacity="0.3" x="-184.451" y="600.973" width="196" height="541.607" rx="2" transform="rotate(-128.7 -184.451 600.973)" fill="url(#paint0_linear_93:235)"></rect><rect opacity="0.3" x="-188.201" y="385.272" width="59.7544" height="541.607" rx="2" transform="rotate(-128.7 -188.201 385.272)" fill="url(#paint1_linear_93:235)"></rect><defs><linearGradient id="paint0_linear_93:235" x1="-90.1184" y1="420.414" x2="-90.1184" y2="1131.65" gradientUnits="userSpaceOnUse"><stop stop-color="#4A6CF7"></stop><stop offset="1" stop-color="#4A6CF7" stop-opacity="0"></stop></linearGradient><linearGradient id="paint1_linear_93:235" x1="-159.441" y1="204.714" x2="-159.441" y2="915.952" gradientUnits="userSpaceOnUse"><stop stop-color="#4A6CF7"></stop><stop offset="1" stop-color="#4A6CF7" stop-opacity="0"></stop></linearGradient></defs></svg></div>
      <div className="mx-auto grid max-w-7xl gap-20 px-6 lg:px-8 xl:grid-cols-1 place-items-center">
        <div className="max-w-xl text-center">
          <h2 className={`text-3xl font-semibold tracking-tight text-pretty  ${mode? "text-amber-100": "text-gray-900"} sm:text-4xl transition delay-150 duration-500 ease`}>
          Simple and Affordable Pricing
          </h2>
          <p className={`mt-6 text-lg/8 ${mode? "text-amber-100": "text-gray-600"} text-center transition delay-150 duration-500 ease`}>
           There are many variations of passages of Lorem Ipsum available but the majority have suffered alteration in some form.
          </p>
        </div>
  ...
  <button className='ease-in-up hidden rounded-sm bg-primary px-8 py-3 text-center font-medium h-12 bg-blue-600 text-white  hover:opacity-75  md:block transition duration-300 '>Start Free Trail</button>

              <span className='border-[1px] border-gray-300'></span>
            <div className='flex flex-col gap-2'>
              <div className='flex items-center'>
              <span class="mr-3 flex h-[18px] w-full max-w-[18px] items-center justify-center rounded-full bg-blue-200 bg-opacity-10 text-blue-500"><svg width="8" height="6" viewBox="0 0 8 6" class="fill-current h-4"><path d="M2.90567 6.00024C2.68031 6.00024 2.48715 5.92812 2.294 5.74764L0.169254 3.43784C-0.0560926 3.18523 -0.0560926 2.78827 0.169254 2.53566C0.39461 2.28298 0.74873 2.28298 0.974086 2.53566L2.90567 4.66497L7.02642 0.189715C7.25175 -0.062913 7.60585 -0.062913 7.83118 0.189715C8.0566 0.442354 8.0566 0.839355 7.83118 1.09198L3.54957 5.78375C3.32415 5.92812 3.09882 6.00024 2.90567 6.00024Z"></path></svg><span></span></span><span className={`text-lg/8  ${mode? "text-amber-100": "text-gray-600"} transition delay-150 duration-500 ease`}>All UI Components</span></div>
              <div className='flex items-center'>
              <span class="mr-3 flex h-[18px] w-full max-w-[18px] items-center justify-center rounded-full bg-blue-200 bg-opacity-10 text-blue-500"><svg width="8" height="6" viewBox="0 0 8 6" class="fill-current h-4"><path d="M2.90567 6.00024C2.68031 6.00024 2.48715 5.92812 2.294 5.74764L0.169254 3.43784C-0.0560926 3.18523 -0.0560926 2.78827 0.169254 2.53566C0.39461 2.28298 0.74873 2.28298 0.974086 2.53566L2.90567 4.66497L7.02642 0.189715C7.25175 -0.062913 7.60585 -0.062913 7.83118 0.189715C8.0566 0.442354 8.0566 0.839355 7.83118 1.09198L3.54957 5.78375C3.32415 5.92812 3.09882 6.00024 2.90567 6.00024Z"></path></svg><span></span></span><span className={`text-lg/8  ${mode? "text-amber-100": "text-gray-600"} transition delay-150 duration-500 ease`}>Use with Unlimited Projects</span></div>
              <div className='flex items-center'>
              <span class="mr-3 flex h-[18px] w-full max-w-[18px] items-center justify-center rounded-full bg-blue-200 bg-opacity-10 text-blue-500"><svg width="8" height="6" viewBox="0 0 8 6" class="fill-current h-4"><path d="M2.90567 6.00024C2.68031 6.00024 2.48715 5.92812 2.294 5.74764L0.169254 3.43784C-0.0560926 3.18523 -0.0560926 2.78827 0.169254 2.53566C0.39461 2.28298 0.74873 2.28298 0.974086 2.53566L2.90567 4.66497L7.02642 0.189715C7.25175 -0.062913 7.60585 -0.062913 7.83118 0.189715C8.0566 0.442354 8.0566 0.839355 7.83118 1.09198L3.54957 5.78375C3.32415 5.92812 3.09882 6.00024 2.90567 6.00024Z"></path></svg><span></span></span><span className={`text-lg/8  ${mode? "text-amber-100": "text-gray-600"} transition delay-150 duration-500 ease`}>Commercial Use </span></div>
              <div className='flex items-center'>
              <span class="mr-3 flex h-[18px] w-full max-w-[18px] items-center justify-center rounded-full bg-blue-200 bg-opacity-10 text-blue-500"><svg width="8" height="6" viewBox="0 0 8 6" class="fill-current h-4"><path d="M2.90567 6.00024C2.68031 6.00024 2.48715 5.92812 2.294 5.74764L0.169254 3.43784C-0.0560926 3.18523 -0.0560926 2.78827 0.169254 2.53566C0.39461 2.28298 0.74873 2.28298 0.974086 2.53566L2.90567 4.66497L7.02642 0.189715C7.25175 -0.062913 7.60585 -0.062913 7.83118 0.189715C8.0566 0.442354 8.0566 0.839355 7.83118 1.09198L3.54957 5.78375C3.32415 5.92812 3.09882 6.00024 2.90567 6.00024Z"></path></svg><span></span></span><span className={`text-lg/8  ${mode? "text-amber-100": "text-gray-600"} transition delay-150 duration-500 ease`}>Email Support </span></div>
              <div className='flex items-center'>
              <span class="mr-3 flex h-[18px] w-full max-w-[18px] items-center justify-center rounded-full bg-blue-200 bg-opacity-10 text-blue-500"><svg width="8" height="6" viewBox="0 0 8 6" class="fill-current h-4"><path d="M7.4499 0.512524C7.1124 0.175024 6.5874 0.175024 6.2499 0.512524L3.9999 2.80002L1.7124 0.512524C1.3749 0.175024 0.849902 0.175024 0.512402 0.512524C0.174902 0.850024 0.174902 1.37502 0.512402 1.71252L2.7999 4.00002L0.512402 6.28752C0.174902 6.62502 0.174902 7.15002 0.512402 7.48752C0.662402 7.63752 0.887402 7.75002 1.1124 7.75002C1.3374 7.75002 1.5624 7.67502 1.7124 7.48752L3.9999 5.20002L6.2874 7.48752C6.4374 7.63752 6.6624 7.75002 6.8874 7.75002C7.1124 7.75002 7.3374 7.67502 7.4874 7.48752C7.8249 7.15002 7.8249 6.62502 7.4874 6.28752L5.1999 4.00002L7.4874 1.71252C7.7874 1.37502 7.7874 0.850024 7.4499 0.512524Z"></path></svg><span></span><span></span></span><span className={`text-lg/8  ${mode? "text-amber-100": "text-gray-600"} transition delay-150 duration-500 ease`}>Lifetime Access</span></div>
              <div className='flex items-center'>
    ...
    viewport={{ once: true }}
            className='flex flex-col gap-15 shadow-md shadow-gray-500 p-10'>
              ...
              <span class="mr-3 flex h-[18px] w-full max-w-[18px] items-center justify-center rounded-full bg-blue-200 bg-opacity-10 text-blue-500"><svg width="8" height="6" viewBox="0 0 8 6" class="fill-current h-4"><path d="M2.90567 6.00024C2.68031 6.00024 2.48715 5.92812 2.294 5.74764L0.169254 3.43784C-0.0560926 3.18523 -0.0560926 2.78827 0.169254 2.53566C0.39461 2.28298 0.74873 2.28298 0.974086 2.53566L2.90567 4.66497L7.02642 0.189715C7.25175 -0.062913 7.60585 -0.062913 7.83118 0.189715C8.0566 0.442354 8.0566 0.839355 7.83118 1.09198L3.54957 5.78375C3.32415 5.92812 3.09882 6.00024 2.90567 6.00024Z"></path></svg><span></span></span><span className={`text-lg/8  ${mode? "text-amber-100": "text-gray-600"} transition delay-150 duration-500 ease`}>Email Support </span></div>
              <div className='flex items-center'>
              <span class="mr-3 flex h-[18px] w-full max-w-[18px] items-center justify-center rounded-full bg-blue-200 bg-opacity-10 text-blue-500"><svg width="8" height="6" viewBox="0 0 8 6" class="fill-current h-4"><path d="M2.90567 6.00024C2.68031 6.00024 2.48715 5.92812 2.294 5.74764L0.169254 3.43784C-0.0560926 3.18523 -0.0560926 2.78827 0.169254 2.53566C0.39461 2.28298 0.74873 2.28298 0.974086 2.53566L2.90567 4.66497L7.02642 0.189715C7.25175 -0.062913 7.60585 -0.062913 7.83118 0.189715C8.0566 0.442354 8.0566 0.839355 7.83118 1.09198L3.54957 5.78375C3.32415 5.92812 3.09882 6.00024 2.90567 6.00024Z"></path></svg><span></span><span></span></span><span className={`text-lg/8  ${mode? "text-amber-100": "text-gray-600"} transition delay-150 duration-500 ease`}>Lifetime Access</span></div>
              <div className='flex items-center'>
              <span className="mr-3 flex h-[18px] w-full max-w-[18px] items-center  justify-center rounded-full bg-blue-200 bg-opacity-10 text-blue-500"><svg width="8" height="6" viewBox="0 0 8 6" className="fill-current h-4"><path d="M7.4499 0.512524C7.1124 0.175024 6.5874 0.175024 6.2499 0.512524L3.9999 2.80002L1.7124 0.512524C1.3749 0.175024 0.849902 0.175024 0.512402 0.512524C0.174902 0.850024 0.174902 1.37502 0.512402 1.71252L2.7999 4.00002L0.512402 6.28752C0.174902 6.62502 0.174902 7.15002 0.512402 7.48752C0.662402 7.63752 0.887402 7.75002 1.1124 7.75002C1.3374 7.75002 1.5624 7.67502 1.7124 7.48752L3.9999 5.20002L6.2874 7.48752C6.4374 7.63752 6.6624 7.75002 6.8874 7.75002C7.1124 7.75002 7.3374 7.67502 7.4874 7.48752C7.8249 7.15002 7.8249 6.62502 7.4874 6.28752L5.1999 4.00002L7.4874 1.71252C7.7874 1.37502 7.7874 0.850024 7.4499 0.512524Z"></path></svg><span></span></span><span className={`text-lg/8  ${mode? "text-amber-100": "text-gray-600"} transition delay-150 duration-500 ease`}>Free Lifetime Updates</span></div>
              </div>
    ...
    <div className={` ${mode? "bg-[#040724]": "bg-gray-100"} py-24 sm:py-32 transition duration-500 ease`}>
      <div className="mx-auto grid max-w-7xl gap-20 px-6 lg:px-8 xl:grid-cols-1 place-items-center">
        <div className="max-w-xl text-center">
          <h2 className={`text-3xl font-semibold tracking-tight text-prett ${mode? "text-amber-100": "text-gray-900"} sm:text-4xl transition delay-150 duration-500 ease`}>
            Our Latest Blogs
          </h2>
          <p className={`mt-6 text-lg/8  ${mode? "text-amber-100": "text-gray-600"} text-center transition delay-150 duration-500 ease`}>
           There are many variations of passages of Lorem Ipsum available but the majority have suffered alteration in some form.
    ...
    className='shadow-md shadow-gray-500 p-10 h-2xs flex flex-col gap-10 justify-around'>
        ...
        Lorem ipsum dolor sited Sed ullam corper consectur adipiscing Mae ornare massa quis lectus.
          ...
          <div className='flex flex-col gap-10 sm:flex-row'>
              ...
              <button className='ease-in-up  rounded-sm bg-primary px-8 py-3 text-center font-medium  sm:w-2xs bg-blue-600 text-white  hover:opacity-75   transition duration-300 '>Subscribe</button>
    
          <h3 className={`font-semibold tracking-tight text-pretty ${mode? "text-amber-100": "text-gray-500"} transition delay-150 duration-500 ease text-center sm:text-start`}>
...
className=' w-2xs flex flex-col p-2 gap-7'>
   <h1 className={`text-2xl font-bold  ${mode? "text-amber-100": "text-gray-900"} transition delay-150 duration-500 ease`}>Useful Links</h1>
    ...
    <ul className='flex flex-col  gap-3'>
      <li className={`${mode? "text-amber-100": "text-gray-500"} hover:text-blue-600 hover:cursor-pointer transition delay-150 duration-500 ease`}>Open Support Ticket</li>
      ...
      <div className='relative top-0 sm:right-0 '>
