  ...
  return (
    <>
     <div className={`${mode? "bg-[#040724]": "bg-white"} relative  w-full flex flex-col justify-center items-center mb:p-0 sm:p-2 sm:px-30  transition duration-500 ease`}>
        <h1 className={`${mode? "text-amber-100": "text-gray-900"} font-bold text-[50px] mb:text-center  text-start leading-tight mt-30 transition delay-150 duration-500 ease`}>Main Feature</h1>
